...
@users = [
  User.new(id: 1, name: "melat", role: "student"),
  User.new(id: 2, name: "josh", role: "student"),
  User.new(id: 3, name: "saron", role: "assistant")
]

@resources = [
  Resource.new(id: 1, name: "Microscope", category: "Lab"),
  Resource.new(id: 102, name: "pH meters", category: "Lab"),
